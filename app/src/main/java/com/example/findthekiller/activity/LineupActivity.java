...
public class LineupActivity extends AppCompatActivity {
    ...
    private void addCharacter() {
        ...
        character.add(new CharacterModel(R.drawable.albert, "Albert", "Male"));
        character.add(new CharacterModel(R.drawable.caleb, "Caleb", "Male"));
        ...
        character.add(new CharacterModel(R.drawable.selena, "Selena", "Female"));
        character.add(new CharacterModel(R.drawable.francis, "Francis", "Female"));
        character.add(new CharacterModel(R.drawable.stephanie, "Stephanie", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.frank, "Frank", "Male"));
        ...
        character.add(new CharacterModel(R.drawable.russell, "Russell", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.steven, "Steven", "Male"));
        ...
        character.add(new CharacterModel(R.drawable.sofia, "Sofia", "Female"));
        character.add(new CharacterModel(R.drawable.steve, "Steve", "Male"));
        character.add(new CharacterModel(R.drawable.alvin, "Alvin", "Male"));
        character.add(new CharacterModel(R.drawable.judith, "Judith", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.william, "William", "Male"));
        character.add(new CharacterModel(R.drawable.ryan, "Ryan", "Male"));
        character.add(new CharacterModel(R.drawable.aldrin, "Aldrin", "Male"));
        character.add(new CharacterModel(R.drawable.raymond, "Raymond", "Male"));
        character.add(new CharacterModel(R.drawable.andrei, "Andrei", "Male"));
        ...
        character.add(new CharacterModel(R.drawable.jasmine, "Jasmine", "Female"));
        character.add(new CharacterModel(R.drawable.adrian, "Adrian", "Male"));
        character.add(new CharacterModel(R.drawable.troy, "Troy", "Male"));
        character.add(new CharacterModel(R.drawable.raver, "Raver", "Male"));
        character.add(new CharacterModel(R.drawable.lloyd, "Lloyd", "Male"));
        character.add(new CharacterModel(R.drawable.oscar, "Oscar", "Male"));
        character.add(new CharacterModel(R.drawable.austin, "Austin", "Male"));
        character.add(new CharacterModel(R.drawable.arnold, "Arnold", "Male"));
        character.add(new CharacterModel(R.drawable.nicole, "Nicole", "Female"));
        character.add(new CharacterModel(R.drawable.natasha, "Natasha", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.amy, "Amy", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.isam, "Isam", "Male"));
        character.add(new CharacterModel(R.drawable.katherine, "Katherine", "Female"));
        character.add(new CharacterModel(R.drawable.daisy, "Daisy", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.valerie, "Valerie", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.ken, "Ken", "Male"));
        character.add(new CharacterModel(R.drawable.clara, "Clara", "Female"));
        character.add(new CharacterModel(R.drawable.trixie, "Trixie", "Female"));
        ...
        character.add(new CharacterModel(R.drawable.vincent, "Vincent", "Male"));
    }
}
